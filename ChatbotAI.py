...
# libaries for creating and training chatbots
...
topic = input("Please enter a topic for the conversation: ")

if topic.upper() == "MOVIES":
    trainer_bob.train(conversation_Movie)    # calls the movie conversation for bob -> to train
    trainer_sue.train(conversation_Movie)    # calls the movie conversation for sue -> to train
    trainer_matt.train(conversation_Movie)   # calls the general conversation for matt -> to train
...
if topic.upper() == "BOOKS":
    trainer_bob.train(conversation_Books)    # calls the book conversation for bob -> to train
    trainer_sue.train(conversation_Books)    # calls the book conversation for sue -> to train
    trainer_matt.train(conversation_Books)   # calls the book conversation for matt -> to train
...
if topic.upper() == "WEATHER":
    trainer_bob.train(conversation_Weather)  # calls the weather conversation for bob -> to train
    trainer_sue.train(conversation_Weather)  # calls the weather conversation for sue -> to train
    trainer_matt.train(conversation_Weather)  # calls the weather conversation for matt -> to train
...
if topic.upper() == "TVSHOWS":
    trainer_bob.train(conversation_TVShow)  # calls the TV shows conversation for bob -> to train
    trainer_sue.train(conversation_TVShow)  # calls the TV Shows conversation for sue -> to train
    trainer_matt.train(conversation_TVShow)  # calls the TV conversation for matt -> to train
